...
option_list$int1 <- make_option('--int1', type='integer')
option_list$int2 <- make_option('--int2', type='integer')
option_list$outV <- make_option('--outV', type='character')
