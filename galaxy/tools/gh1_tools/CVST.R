...
option_list$EXFILE <- make_option('--EXFILE', type='character')
option_list$OutCV <- make_option('--OutCV', type='character')
option_list$OutPlot <- make_option('--OutPlot', type='character')
